...
dir.create("Model_results_ARSA_run14")
dir.create("Model_results_ARSA_run14/Plots")
...
rjn_data <- list(timeC = rjn.landings$Year, obsC = rjn.landings$Total_landings,
                timeI = list(rjn.index$Year+3/12, rjn.index$Year+11/12),
                obsI = list(rjn.index$Q1_B_kg, rjn.index$Q4_B_kg))
...
xtab(sumspict.parest(rjn_model),caption="ARSA_run14_Parameter estimates",cornername="Parameter",file="Model_results_ARSA_run14/ARSA_run14_Parameter_estimates.xls",dec=rep(4,ncol(sumspict.parest(rjn_model))))
xtab(sumspict.states(rjn_model),caption="ARSA_run14_states of the model",cornername="",file="Model_results_ARSA_run14/ARSA_run14_states of the model.xls",dec=rep(4,ncol(sumspict.states(rjn_model))))
xtab(sumspict.predictions(rjn_model),caption="ARSA_run14_predictions",cornername="",file="Model_results_ARSA_run14/ARSA_run14_predictions.xls",dec=rep(4,ncol(sumspict.predictions(rjn_model))))
...
xtab(calc.om(rjn_model),caption="ARSA_run14_magnitude",cornername="",file="Model_results_ARSA_run14/ARSA_run14_magnitude.xls",dec=rep(4,ncol(calc.om(rjn_model))))
...
xtab(rjn_model_ini$check.ini$resmat,caption="ARSA_run14_initial values",cornername="",file="Model_results_ARSA_run14/ARSA_run14_initial values.xls",dec=rep(4,ncol(rjn_model_ini$check.ini$resmat)))
...
xtab(cov2cor(rjn_model$cov.fixed),caption="ARSA_run14_correlation between parameters",cornername="",file="Model_results_ARSA_run14/ARSA_run14_correlation between parameters.xls",dec=rep(4,ncol(cov2cor(rjn_model$cov.fixed))))
...
tiff(filename = "Model_results_ARSA_run14/Plots/hindcast.tiff")
plotspict.hindcast(hc.rjn_model,legend.pos = "topleft")
dev.off()
...
tiff(filename = "Model_results_ARSA_run14/Plots/Fit_results_1.tiff")
plot(rjn_model)
dev.off()
...
tiff(filename = "Model_results_ARSA_run14/Plots/plot_data.tiff")
plotspict.data(rjn_data)
dev.off()

tiff(filename = "Model_results_ARSA_run14/Plots/Priors.tiff")
plotspict.priors(rjn_model)
dev.off()


tiff(filename = "Model_results_ARSA_run14/Plots/Biomass.tiff")
plotspict.biomass(rjn_model)
dev.off()

tiff(filename = "Model_results_ARSA_run14/Plots/FishingM.tiff")
plotspict.f(rjn_model)
dev.off()

tiff(filename = "Model_results_ARSA_run14/Plots/BBmsy.tiff")
plotspict.bbmsy(rjn_model)
dev.off()

tiff(filename = "Model_results_ARSA_run14/Plots/FFmsy.tiff")
plotspict.ffmsy(rjn_model)
dev.off()


tiff(filename = "Model_results_ARSA_run14/Plots/Diagnostics.tiff")
plotspict.diagnostic(rjn_model)
dev.off()

tiff(filename = "Model_results_ARSA_run14/Plots/Retrospective.tiff")
plotspict.retro(retro_rjn_model)
dev.off()
...
xtab(tab1,caption="Parameter estimates",cornername="Parameter",file="Model_results_ARSA_run14/Parameter_estimates.xls",dec=rep(4,ncol(tab1)))

tab2 <- sumspict.srefpoints(rjn_model);
xtab(tab2,caption="Stochastic reference points",cornername="Reference points",file="Model_results_ARSA_run14/Reference_points.html",dec=rep(4,ncol(tab2)))

tab3 <- sumspict.states(rjn_model);
xtab(tab3,caption="Estimated states",cornername="",file="Model_results_ARSA_run14/Estimated_states.html",dec=rep(4,ncol(tab3)))

tab4 <- sumspict.predictions(rjn_model);
xtab(tab4,caption="Forecast",cornername="",file="Model_results_ARSA_run14/Forecast.html",dec=rep(4,ncol(tab4)))

tab5 <- get.par("logBBmsy",rjn_model,exp=TRUE)
tab5_<- tab5[grep(".",rownames(tab5), fixed=TRUE, invert=TRUE),] 
xtab(tab5_,caption="B/Bmsy",cornername="",file="Model_results_ARSA_run14/BBmsy.html",dec=rep(4,ncol(tab5_)))
xtab(tab5,caption="B/Bmsy",cornername="",file="Model_results_ARSA_run14/BBmsy_all.html",dec=rep(4,ncol(tab5)))
...
xtab(tab6,caption="F/Fmsy",cornername="",file="Model_results_ARSA_run14/FFmsy.html",dec=rep(4,ncol(tab6)))
xtab(tab6_,caption="F/Fmsy",cornername="",file="Model_results_ARSA_run14/FFmsy_end year.html",dec=rep(4,ncol(tab6_)))

tab6b <- get.par("logF",rjn_model,exp=TRUE)
xtab(tab6b,caption="F",cornername="",file="Model_results_ARSA_run14/F_results.html",dec=rep(4,ncol(tab6b)))


tab6c <- get.par("logCpred",rjn_model,exp=TRUE)
xtab(tab6c,caption="Catch",cornername="",file="Model_results_ARSA_run14/Catch.html",dec=rep(4,ncol(tab6c)))
...
write.csv(res, "Model_results_ARSA_run14/Forecast_selected_scenarios.csv")
